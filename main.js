...
function monitorNecrosis(img) {
    ...
    if (getSetting("track_fod")) {
        if (is6 || is8 || is10 || is12) {
            alt1.overLayImage(loc.x + 6, loc.y + 6, fod_big, 60, 200);
            alt1.overLayRect(alt1__WEBPACK_IMPORTED_MODULE_4__.mixColor(255, 255, 255), loc.x + 3, loc.y + 3, 63, 63, 200, 3);
        }
    }
    if (getSetting("track_strike")) {
        if (soul1 || soul2) {
            alt1.overLayImage(loc.x + 71, loc.y + 6, strike, 60, 200);
            alt1.overLayRect(alt1__WEBPACK_IMPORTED_MODULE_4__.mixColor(255, 255, 255), loc.x + 68, loc.y + 3, 63, 63, 200, 3);
        }
    }
    if (getSetting("track_volley")) {
        if (soul3 || soul4 || soul5) {
            alt1.overLayImage(loc.x + 71, loc.y + 6, volley, 60, 200);
            alt1.overLayRect(alt1__WEBPACK_IMPORTED_MODULE_4__.mixColor(255, 255, 255), loc.x + 68, loc.y + 3, 63, 63, 200, 3);
        }
    }
}
